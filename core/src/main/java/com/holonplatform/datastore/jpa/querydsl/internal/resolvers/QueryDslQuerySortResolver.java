...
/**
 * QueryDsl {@link QuerySort} expression resolver.
 *
 * @since 5.0.0
 */
@Priority(Integer.MAX_VALUE)
public enum QueryDslQuerySortResolver implements ExpressionResolver<QuerySort, OrderSpecifierExpression> {
	 ...
	 */
	@Override
	public Optional<OrderSpecifierExpression> resolve(QuerySort expression,
		...
		if (sort.isPresent()) {
			sort.get().validate();
			return context.resolve(sort.get(), OrderSpecifierExpression.class, context);
		}
