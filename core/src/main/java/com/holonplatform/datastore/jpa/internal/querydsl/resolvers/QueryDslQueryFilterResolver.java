...
public enum QueryDslQueryFilterResolver implements ExpressionResolver<QueryFilter, PredicateExpression> {
	 ...
	 */
	@Override
	public Optional<PredicateExpression> resolve(QueryFilter expression, ResolutionContext context)
