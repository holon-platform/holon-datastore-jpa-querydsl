...
public class UselessResolver implements QueryFilterResolver<UselessFilter> {
	 ...
	 */
	@Override
	public Class<? extends UselessFilter> getExpressionType() {
		return UselessFilter.class;
	}
	 ...
	 */
	@Override
	public Optional<QueryFilter> resolve(UselessFilter expression,
