...
@ContextConfiguration(classes = TestJpaQueryDslDatastoreHibernate.Config.class)
@DirtiesContext
public class TestJpaQueryDslDatastoreHibernate extends AbstractQueryDslTest {
